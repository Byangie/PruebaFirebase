package com.example.pruebafirebase.view.login
...
import com.example.pruebafirebase.components.Alert
...
fun LoginView(navController: NavController, loginViewModel : LoginViewModel ){
    Column(horizontalAlignment = Alignment.CenterHorizontally,
        ...
        OutlinedTextField(
            ...
            label = {Text ("Password")},
            visualTransformation = PasswordVisualTransformation(), //usar para ocultar
